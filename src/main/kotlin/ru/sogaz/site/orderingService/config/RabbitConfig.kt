...
@Configuration
class RabbitConfig(private val props: RabbitProps) {
    ...
    @Bean
    fun listenerFactory(connectionFactory: ConnectionFactory, messageConverter: MessageConverter): SimpleRabbitListenerContainerFactory {
